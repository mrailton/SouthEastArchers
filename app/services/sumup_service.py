...
class SumUpService:
    ...
    def create_checkout(self, amount, currency='EUR', description='', checkout_reference='', 
                       merchant_code=None):
        """
    ...
    def process_checkout_payment(self, checkout_id, card_number, card_name, expiry_month, 
                                expiry_year, cvv, payment_type='card'):
        """
        ...
        try:
            ...
            # Create process body
            process_body = ProcessCheckoutBody(
                payment_type=payment_type,
                card=card
            )
            
            # Process the checkout
            response = self.client.checkouts.process(
                id=checkout_id,
                body=process_body
            )
