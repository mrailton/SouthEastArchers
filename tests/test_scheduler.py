...
class TestEvent:
    ...
    def test_event_without_description_uses_callback_name(self):
    ...
    def test_is_due_every_minute(self):
    ...
    def test_is_due_every_five_minutes(self):
    ...
    def test_weekdays_constraint(self):
    ...
    def test_weekends_constraint(self):
    ...
    def test_mondays_constraint(self):
    ...
    def test_tuesdays_constraint(self):
    ...
    def test_run_executes_callback(self):
...
class TestSchedule:
    ...
    def test_call_uses_callback_name_when_no_description(self):
    ...
    def test_command_executes_management_command(self):
    ...
    def test_due_events_returns_due_tasks(self):
    ...
    def test_run_due_tasks_continues_on_error(self):
    ...
    def test_all_events_returns_all_events(self):
