...
def test_verify_valid_reset_token(app, test_user):
...
def test_verify_invalid_reset_token(app):
...
def test_verify_expired_reset_token(app, test_user):
...
def test_reset_password_with_valid_token(app, client, test_user):
