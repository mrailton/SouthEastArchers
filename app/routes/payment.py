...
def process_checkout(checkout_id):
    ...
    try:
        ...
        if result.get('success'):
            ...
            user_id = session.get('signup_user_id') or session.get('membership_renewal_user_id') or session.get('credit_purchase_user_id') or (current_user.id if current_user.is_authenticated else None)
            ...
            if session.get('signup_user_id'):
                ...
                if payment and user:
                    ...
                    flash('Payment successful! Your membership is now active. A receipt has been sent to your email.', 'success')
            ...
            # Handle membership renewal
                ...
                if payment and user:
                    ...
                    flash('Membership renewed successfully! A receipt has been sent to your email.', 'success')
