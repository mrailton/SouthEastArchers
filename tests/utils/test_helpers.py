...
class TestSendEmail:
    ...
    def test_send_email_with_text_only(self, mock_send, app):
    ...
    @patch("app.utils.helpers.mail.send")
    def test_send_email_with_html(self, mock_send, app):
    ...
    @patch("app.utils.helpers.mail.send")
    def test_send_email_multiple_recipients(self, mock_send, app):
    ...
    @patch("app.utils.helpers.mail.send")
    def test_send_email_creates_message_correctly(self, mock_send, app):
    ...
    @patch("app.utils.helpers.mail.send")
    def test_send_email_without_html_body(self, mock_send, app):
    ...
    @patch("app.utils.helpers.mail.send")
    def test_send_email_with_empty_html_body(self, mock_send, app):
