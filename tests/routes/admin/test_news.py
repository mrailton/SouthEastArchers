...
class TestAdminNews:
    ...
    def test_create_news_success_published(self, client, admin_user, app):
    ...
    def test_create_news_success_unpublished(self, client, admin_user, app):
    ...
    def test_edit_news_publish(self, client, admin_user, app):
    ...
    def test_edit_news_already_published_keeps_date(self, client, admin_user, app):
    ...
    def test_edit_news_unpublish(self, client, admin_user, app):
