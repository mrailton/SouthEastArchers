...
@section('title', 'Create Shoot')

@section('content')
<div class="max-w-2xl mx-auto">
    <h1 class="text-4xl font-bold mb-6">Create Shoot</h1>
    
    <div class="bg-white p-8 rounded shadow">
        <form method="POST" action="{{ route('admin.shoots.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input class="w-full border border-gray-300 rounded px-3 py-2 @error('date') border-red-500 @enderror" 
                           type="date" id="date" name="date" value="{{ old('date') }}" required>
                    @error('date')
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mb-2">Credits will be deducted for selected attendees.</p>
            ...
            <div class="flex gap-4">
                <button type="submit" class="btn-primary py-2 px-6">Create Shoot</button>
