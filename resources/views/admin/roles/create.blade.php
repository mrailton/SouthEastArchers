...
<div class="max-w-2xl mx-auto">
    <h1 class="text-4xl font-bold mb-6">Create Role</h1>
    ...
    <div class="bg-white p-8 rounded shadow">
        <form method="POST" action="{{ route('admin.roles.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input class="w-full border border-gray-300 rounded px-3 py-2" type="text" id="name" name="name" value="{{ old('name') }}" required>
            </div>
            ...
            <div class="flex gap-4">
                <button type="submit" class="btn-primary py-2 px-6">Create Role</button>
