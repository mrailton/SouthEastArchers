...
def test_events_list(client, admin_user):
...
def test_events_list_shows_edit_buttons(client, admin_user, app):
...
def test_events_list_empty_state(client, admin_user):
...
def test_create_event_page(client, admin_user):
...
def test_edit_event_page(client, admin_user, app):
...
def test_edit_event_success(client, admin_user, app):
    """Test updating event"""
    from app import db
...
def test_edit_event_not_found(client, admin_user):
...
def test_events_requires_admin(client, test_user):
...
def test_create_event_invalid_date(client, admin_user):
...
def test_edit_event_requires_admin(client, test_user, app):
