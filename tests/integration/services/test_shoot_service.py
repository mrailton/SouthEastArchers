...
def test_zero_credits_goes_negative(app):
...
def test_already_negative_goes_more_negative(app):
...
def test_multiple_attendees_mixed_credits(app):
...
def test_inactive_membership_cannot_go_negative(app):
...
def test_expired_membership_cannot_go_negative(app):
...
def test_last_credit_no_warning(app):
...
def test_all_attendees_zero_credits(app):
...
def test_purchased_credits_used_before_going_negative(app):
...
def test_add_zero_credit_attendee(app):
...
def test_add_already_negative_attendee(app):
...
def test_remove_negative_attendee_refunds_credit(app):
...
def test_swap_attendees_one_negative(app):
...
def test_inactive_membership_refused_on_update(app):
...
def test_expired_membership_refused_on_update(app):
...
def test_deeply_negative_warning(app):
...
def test_inactive_warning_message(app):
    user = _create_member(
        name="Inactive Ian",
        email="ian@test.com",
        initial_credits=0,
