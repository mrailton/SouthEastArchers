"""Tests for shoot management CLI commands."""
...
class TestShootCreate:
    def test_create_shoot(self, runner):
    ...
    def test_create_shoot_without_description(self, runner):
        shoot_date = (date.today() + timedelta(days=7)).strftime("%Y-%m-%d")
...
class TestShootList:
    ...
    def test_list_header_format(self, runner):
    ...
    def test_list_upcoming_flag(self, runner):
