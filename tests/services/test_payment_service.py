...
class TestPaymentService:
    ...
    def test_create_checkout_success(self, app, test_user):
    ...
    def test_create_checkout_failure(self, app, test_user):
    ...
    def test_process_payment_success(self, app):
    ...
    def test_initiate_membership_payment_success(self, app, test_user):
    ...
    def test_initiate_membership_payment_checkout_fails(self, app, test_user):
    ...
    def test_initiate_credit_purchase_success(self, app, test_user):
    ...
    def test_initiate_credit_purchase_checkout_fails(self, app, test_user):
    ...
    def test_initiate_credit_purchase_different_quantities(self, app, test_user):
...
class TestPaymentProcessingService:
    ...
    def test_handle_payment_failure_failed_status(self, app):
    ...
    def test_handle_payment_failure_pending_status(self, app):
    ...
    def test_handle_payment_failure_unknown_status(self, app):
    ...
    def test_handle_membership_renewal_creates_membership_if_missing(self, app, test_user):
    ...
    def test_queue_payment_receipt_with_task_queue(self, app, test_user):
    ...
    def test_queue_payment_receipt_task_queue_exception(self, app, test_user):
    ...
    def test_queue_payment_receipt_fallback_to_direct_send(self, app, test_user):
    ...
    def test_queue_payment_receipt_fallback_send_exception(self, app, test_user):
    ...
    def test_handle_signup_payment_with_membership(self, app, test_user):
    ...
    def test_handle_credit_purchase_with_quantity(self, app, test_user):
