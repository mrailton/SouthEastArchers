...
# TestSendMembershipExpiryReminderJob


@patch("app.services.background_jobs.render_template")
@patch("app.services.background_jobs.mail.send")
def test_send_membership_expiry_reminder_job(mock_mail_send, mock_render, app, test_user_with_payment):
...
@patch("app.services.background_jobs.mail.send")
def test_send_membership_expiry_reminder_job_missing_user(mock_mail_send, app):
...
@patch("app.services.background_jobs.mail.send")
def test_send_membership_expiry_reminder_job_no_membership(mock_mail_send, app):
...
@patch("app.services.background_jobs.render_template")
@patch("app.services.background_jobs.mail.send")
def test_send_membership_expiry_reminder_job_without_app_context(mock_mail_send, mock_render, test_user_with_payment):
...
@patch("app.services.background_jobs.render_template")
@patch("app.services.background_jobs.mail.send")
def test_send_membership_expiry_reminder_calculates_days(mock_mail_send, mock_render, app, test_user_with_payment):
...
# TestCheckExpiringMembershipsJob


@patch("app.services.background_jobs.send_membership_expiry_reminder_job")
def test_check_expiring_memberships_job(mock_send_reminder, app):
...
@patch("app.services.background_jobs.send_membership_expiry_reminder_job")
def test_check_expiring_memberships_excludes_inactive_users(mock_send_reminder, app):
...
def test_check_expiring_memberships_continues_on_error(mock_send_reminder, app):
...
@patch("app.services.background_jobs.send_membership_expiry_reminder_job")
def test_check_expiring_memberships_without_app_context(mock_send_reminder, app):
...
def test_check_expiring_memberships_no_expiring(app):
