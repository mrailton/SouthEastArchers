...
class TestActivateMembership:
    def test_activate_pending_membership(self, app, user_with_pending_membership):
    ...
    def test_activate_with_pending_cash_payment(self, app, user_with_cash_payment):
    ...
    def test_activate_already_active_membership(self, app, test_user):
...
class TestRenewMembership:
    def test_renew_active_membership(self, app, test_user):
    ...
    def test_renew_expired_membership(self, app, test_user):
...
class TestDeactivateMembership:
    def test_deactivate_active_membership(self, app, test_user):
    ...
    def test_deactivate_already_inactive_membership(self, app, test_user):
...
class TestGetExpiringMemberships:
    def test_get_expiring_memberships_default_30_days(self, app):
    ...
    def test_get_expiring_memberships_empty(self, app):
...
class TestGetExpiredMemberships:
    def test_get_expired_memberships(self, app):
