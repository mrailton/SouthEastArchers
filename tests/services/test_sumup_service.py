...
# ProcessCheckoutPayment tests


@patch("app.services.sumup_service.Sumup")
def test_process_payment_success(mock_sumup_class, app):
...
@patch("app.services.sumup_service.Sumup")
def test_process_payment_converts_two_digit_year(mock_sumup_class, app):
...
@patch("app.services.sumup_service.Sumup")
def test_process_payment_pads_month(mock_sumup_class, app):
...
@patch("app.services.sumup_service.Sumup")
def test_process_payment_failed_status(mock_sumup_class, app):
...
@patch("app.services.sumup_service.APIError", MockAPIError)
@patch("app.services.sumup_service.Sumup")
def test_process_payment_api_error(mock_sumup_class, app):
...
@patch("app.services.sumup_service.Sumup")
def test_process_payment_generic_exception(mock_sumup_class, app):
...
@patch("app.services.sumup_service.APIError", MockAPIError)
@patch("app.services.sumup_service.Sumup")
def test_process_payment_api_error_with_body(mock_sumup_class, app):
