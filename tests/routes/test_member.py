...
def test_dashboard_logged_in(client, test_user):
...
def test_view_shoots_history(client, test_user, app):
    from app import db
...
def test_view_profile(client, test_user):
...
def test_view_credits_page(client, test_user):
...
def test_shoots_with_no_history(client, test_user):
...
def test_update_profile_partial_data(client, test_user):
