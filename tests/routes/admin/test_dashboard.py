...
def test_dashboard_requires_admin(client, test_user):
...
def test_dashboard_with_admin(client, admin_user):
...
def test_dashboard_displays_stats(client, admin_user, test_user, app):
...
def test_dashboard_shows_recent_members(client, admin_user, test_user, app):
