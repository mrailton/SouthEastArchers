...
def test_create_event_with_location(app):
...
def test_create_event_with_capacity(app):
...
def test_is_upcoming_future_event(app):
...
def test_is_upcoming_past_event(app):
