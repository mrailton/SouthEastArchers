...
class TestAdminShoots:
    ...
    def test_create_shoot_with_attendees(self, client, admin_user, test_user, app):
    ...
    def test_edit_shoot_add_attendee(self, client, admin_user, test_user, app):
    ...
    def test_edit_shoot_remove_attendee(self, client, admin_user, test_user, app):
    ...
    def test_create_shoot_attendee_no_credits(self, client, admin_user, app):
    ...
    def test_edit_shoot_get_prepopulates_data(self, client, admin_user, test_user, app):
    ...
    def test_edit_shoot_requires_admin(self, client, test_user, app):
    ...
    def test_shoots_list_shows_all_shoots(self, client, admin_user, app):
